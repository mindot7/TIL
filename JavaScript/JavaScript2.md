...
- 1004년 당시 넷스케이프 커뮤니케이션스사의 Netscape Navigator(NN) 브라우저가 전 세계 점유율을 80% 이상 독점하며 브라우저의 표준 역할을 함
...
- 빌 게이츠 주도하에 MS는 1997년 IE 4를 발표하면서 시장을 장악하기 시작
  ...
  - 글로벌 기업 MS의 공격적인 마케팅
- MS의 승리로 끝나며 20001년부터 IE의 점유율은 90%를 상회
...
![구조1](JavaScript2.assets/구조1.PNG)

- Element

  - Document 안의 모든 객체가 상속하는 가장 범용적인 ㅇ니터페이스
...
- HTMLElement
  ...
  ![구조2](JavaScript2.assets/구조2.PNG)
...
- querySelector(), querySelectorAll()을 사용하는 이유
  ...
  - id, clas 그리고 tag 선택자 등을 모두 사용 가능하므로, 더 구체적이고 유연하게 선택 가능
...
- ex) 게시판이나 메일 등 악성 자바 스크립트 코드를 삽입해 민감한 정보를 탈취할 수 있음
...
- AnnimationEvent, ClipboardEvent, DragEvent 등
- UIEvent
  - 간단한 사용자 인터페이스 이벤트
  - Event의 상속을 받음
  - MouseEvent, KeyboardEvent, InputEvent, FocusEvent 등의 부모 객체 역할을 함

![이벤트](JavaScript2.assets/이벤트.PNG)



### Event는 왜 필요할까?

![이벤트필요](JavaScript2.assets/이벤트필요.PNG)
...
- target.addEventListner(type, listnerp, options])
  ...
  - listner
    ...
    - 지정된 타입의 이벤트가 발생했을 때 알림을 받는 객체
      ...
      EventListner 인터페이스 혹은 JS function 객체(콜백 함수)여야 함
